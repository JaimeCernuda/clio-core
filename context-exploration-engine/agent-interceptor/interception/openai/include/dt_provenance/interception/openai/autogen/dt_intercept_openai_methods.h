#ifndef DT_PROVENANCE_INTERCEPTION_OPENAI_AUTOGEN_METHODS_H_
#define DT_PROVENANCE_INTERCEPTION_OPENAI_AUTOGEN_METHODS_H_
...
#endif  // DT_PROVENANCE_INTERCEPTION_OPENAI_AUTOGEN_METHODS_H_
