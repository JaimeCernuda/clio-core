#ifndef DT_PROVENANCE_INTERCEPTION_OLLAMA_AUTOGEN_METHODS_H_
#define DT_PROVENANCE_INTERCEPTION_OLLAMA_AUTOGEN_METHODS_H_
...
#endif  // DT_PROVENANCE_INTERCEPTION_OLLAMA_AUTOGEN_METHODS_H_
